...
void driver_wait_until_title_is(char *title);
void driver_wait_until_title_contains(char *key);
void driver_wait_until_presence_of_element_located();
void driver_wait_until_visibility_of_element_located();
void driver_wait_until_visibility_of();
void driver_wait_until_presence_of_all_elements_located();
void driver_wait_until_text_to_be_present_in_element();
void driver_wait_until_text_to_be_present_in_element_value();
void driver_wait_until_frame_to_be_available_and_switch_to_it();
void driver_wait_until_invisibility_of_element_located();
void driver_wait_until_element_to_be_clickable();
void driver_wait_until_staleness_of(char *staleness);
void driver_wait_until_element_to_be_selected();
void driver_wait_until_element_located_to_be_selected();
void driver_wait_until_element_selection_state_to_be(char *state);
void driver_wait_until_element_located_selection_state_to_be(char *state);
void driver_wait_until_alert_is_present();
